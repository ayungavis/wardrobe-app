...
public protocol PhotoLibraryBrowsing: Sendable {
...
public extension PhotoLibraryBrowsing {
    ...
    public actor PHPhotoLibraryBrowser: PhotoLibraryBrowsing {
        public init() {}
    ...
    public struct NoopPhotoLibraryBrowser: PhotoLibraryBrowsing {
        public init() {}
        public func access() async -> PhotoLibraryAccess {
            .denied
        }
